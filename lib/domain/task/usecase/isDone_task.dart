...
class IsDoneTaskUseCase extends UseCase<Either, String>{
  @override
  Future<Either> call({String? params,bool? isDone}) async {
    return await sl<TaskRepository>().isDone(params!, isDone!);
  }
